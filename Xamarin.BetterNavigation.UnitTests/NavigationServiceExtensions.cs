...
namespace Xamarin.BetterNavigation.UnitTests
{
    public static class NavigationServiceExtensions
    {
        ...
        public static Task PopPageAndGoToAsync(this INavigationService navigationService, IEnumerable<ApplicationPage> pages, bool animated, params (string key, object value)[] navigationParameters)
    => navigationService.PopPageAndGoToAsync(pages.Select(p => p.ToString()), animated, navigationParameters);

        public static Task PopPageAndGoToAsync(this INavigationService navigationService, IEnumerable<ApplicationPage> pages, params (string key, object value)[] navigationParameters)
            => navigationService.PopPageAndGoToAsync(pages.Select(p => p.ToString()), navigationParameters);
        ...
        public static Task PopPageAndGoToAsync(this INavigationService navigationService, byte numberOfPagesToPop, IEnumerable<ApplicationPage> pages, params (string key, object value)[] navigationParameters)
    => navigationService.PopPageAndGoToAsync(numberOfPagesToPop, pages.Select(p => p.ToString()), navigationParameters);

        public static Task PopPageAndGoToAsync(this INavigationService navigationService, byte numberOfPagesToPop, IEnumerable<ApplicationPage> pages, bool animated, params (string key, object value)[] navigationParameters)
            => navigationService.PopPageAndGoToAsync(numberOfPagesToPop, pages.Select(p => p.ToString()), animated, navigationParameters);
